...
my_Customer = Customer("Pong", "Phantabat@gmail.com", "Bangkok")
my_OnlineShop = OnlineShop("ECS Store", "https://ee-eng.su.ac.th")

my_Product1 = Product("Wireless Mouse", "A smooth and silent wireless mouse", 850, my_OnlineShop)
my_Product2 = Product("Mechanical Keyboard", "RGB mechanical keyboard with blue switches", 1590, my_OnlineShop)
my_Product3 = Product("USB-C Hub", "7-in-1 USB-C hub for laptops", 990, my_OnlineShop)
my_Product4 = Product("Monitor", "Full HD IPS monitor with HDMI and DisplayPort", 6270, my_OnlineShop)
